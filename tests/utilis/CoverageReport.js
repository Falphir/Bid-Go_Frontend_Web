...
const htmlFile = path.join(reportsDir, 'coverage_report.html');
const pdfFile = path.join(reportsDir, 'coverage_report.pdf');
...
<body>
    ...
    <p>O presente relatório apresenta os resultados da análise de cobertura de testes do sistema <strong>Bid-Go (Web)</strong>, com o objetivo de avaliar a abrangência e a eficácia dos testes automatizados implementados. A cobertura de testes constitui um indicador essencial da qualidade do <em>software</em>, permitindo identificar as áreas de código que foram, ou não, verificadas durante a execução dos testes.</p>
    
    <p>Os resultados foram obtidos através da recolha de métricas durante a execução dos testes E2E, abrangendo componentes, páginas e a lógica de interface da aplicação. Este relatório fornece uma visão detalhada sobre a percentagem de linhas e ramos de código testados, possibilitando uma avaliação objetiva da robustez e da fiabilidade do sistema.</p>
